...
#if UNITY_EDITOR
[CustomEditor(typeof(Calendar_TableDataReader))]
public class Calendar_TableDataReaderEditor : Editor
{
    private Calendar_TableDataReader data;
    ...
    void OnEnable()
    {
        data = (Calendar_TableDataReader)target;
    }
