...
#if UNITY_EDITOR
[CustomEditor(typeof(EndingEventDataReader))]
public class EndingEventDataReaderEditor : Editor
{
    private EndingEventDataReader data;
    ...
    void OnEnable()
    {
        data = (EndingEventDataReader)target;
    }
