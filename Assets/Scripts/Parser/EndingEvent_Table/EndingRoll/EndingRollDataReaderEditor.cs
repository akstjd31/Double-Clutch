...
#if UNITY_EDITOR
[CustomEditor(typeof(EndingRollDataReader))]
public class EndingRollDataReaderEditor : Editor
{
    private EndingRollDataReader data;
    ...
    void OnEnable()
    {
        data = (EndingRollDataReader)target;
    }
