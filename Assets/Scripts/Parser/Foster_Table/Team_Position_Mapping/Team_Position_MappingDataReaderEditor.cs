...
#if UNITY_EDITOR
[CustomEditor(typeof(Team_Position_MappingDataReader))]
public class Team_Position_MappingDataReaderEditor : Editor
{
    private Team_Position_MappingDataReader data;
    ...
    void OnEnable()
    {
        data = (Team_Position_MappingDataReader)target;
    }
