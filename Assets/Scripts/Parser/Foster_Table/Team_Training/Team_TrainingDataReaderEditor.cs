...
#if UNITY_EDITOR
[CustomEditor(typeof(Team_TrainingDataReader))]
public class Team_TrainingDataReaderEditor : Editor
{
    private Team_TrainingDataReader data;
    ...
    void OnEnable()
    {
        data = (Team_TrainingDataReader)target;
    }
