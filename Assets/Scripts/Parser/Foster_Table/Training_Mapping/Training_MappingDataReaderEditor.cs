...
#if UNITY_EDITOR
[CustomEditor(typeof(Training_MappingDataReader))]
public class Training_MappingDataReaderEditor : Editor
{
    private Training_MappingDataReader data;
    ...
    void OnEnable()
    {
        data = (Training_MappingDataReader)target;
    }
