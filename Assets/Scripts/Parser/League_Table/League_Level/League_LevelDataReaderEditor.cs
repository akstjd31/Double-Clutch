...
#if UNITY_EDITOR
[CustomEditor(typeof(League_LevelDataReader))]
public class League_LevelDataReaderEditor : Editor
{
    private League_LevelDataReader data;
    ...
    void OnEnable()
    {
        data = (League_LevelDataReader)target;
    }
