...
#if UNITY_EDITOR
[CustomEditor(typeof(League_MasterDataReader))]
public class League_MasterDataReaderEditor : Editor
{
    private League_MasterDataReader data;
    ...
    void OnEnable()
    {
        data = (League_MasterDataReader)target;
    }
