...
#if UNITY_EDITOR
[CustomEditor(typeof(League_RewardDataReader))]
public class League_RewardDataReaderEditor : Editor
{
    private League_RewardDataReader data;
    ...
    void OnEnable()
    {
        data = (League_RewardDataReader)target;
    }
