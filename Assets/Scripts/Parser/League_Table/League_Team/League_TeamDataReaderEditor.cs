...
#if UNITY_EDITOR
[CustomEditor(typeof(League_TeamDataReader))]
public class League_TeamDataReaderEditor : Editor
{
    private League_TeamDataReader data;
    ...
    void OnEnable()
    {
        data = (League_TeamDataReader)target;
    }
