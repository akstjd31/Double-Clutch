...
#if UNITY_EDITOR
[CustomEditor(typeof(Rival_MasterDataReader))]
public class Rival_MasterDataReaderEditor : Editor
{
    private Rival_MasterDataReader data;
    ...
    void OnEnable()
    {
        data = (Rival_MasterDataReader)target;
    }
