...
#if UNITY_EDITOR
[CustomEditor(typeof(Halftime_ListDataReader))]
public class Halftime_ListDataReaderEditor : Editor
{
    private Halftime_ListDataReader data;
    ...
    void OnEnable()
    {
        data = (Halftime_ListDataReader)target;
    }
