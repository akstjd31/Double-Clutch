...
#if UNITY_EDITOR
[CustomEditor(typeof(Halftime_ScriptDataReader))]
public class Halftime_ScriptDataReaderEditor : Editor
{
    private Halftime_ScriptDataReader data;
    ...
    void OnEnable()
    {
        data = (Halftime_ScriptDataReader)target;
    }
