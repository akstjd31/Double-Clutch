...
#if UNITY_EDITOR
[CustomEditor(typeof(Mercenary_DataReader))]
public class Mercenary_DataReaderEditor : Editor
{
    private Mercenary_DataReader data;
    ...
    void OnEnable()
    {
        data = (Mercenary_DataReader)target;
    }
