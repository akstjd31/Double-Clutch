...
#if UNITY_EDITOR
[CustomEditor(typeof(Position_PresetDataReader))]
public class Position_PresetDataReaderEditor : Editor
{
    private Position_PresetDataReader data;
    ...
    void OnEnable()
    {
        data = (Position_PresetDataReader)target;
    }
