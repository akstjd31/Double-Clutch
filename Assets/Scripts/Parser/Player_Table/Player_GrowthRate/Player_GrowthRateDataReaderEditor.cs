...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_GrowthRateDataReader))]
public class Player_GrowthRateDataReaderEditor : Editor
{
    private Player_GrowthRateDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_GrowthRateDataReader)target;
    }
