...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_MaxPotentialDataReader))]
public class Player_MaxPotentialDataReaderEditor : Editor
{
    private Player_MaxPotentialDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_MaxPotentialDataReader)target;
    }
    ...
    void UpdateMethodOne(GstuSpreadSheet ss)
    {
        ...
        Debug.Log($"[Player_MaxPotentialDataReader] Loaded: {data.DataList.Count} rows");
    }
