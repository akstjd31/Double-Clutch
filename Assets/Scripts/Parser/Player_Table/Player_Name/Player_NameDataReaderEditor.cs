...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_NameDataReader))]
public class Player_NameDataReaderEditor : Editor
{
    private Player_NameDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_NameDataReader)target;
    }
