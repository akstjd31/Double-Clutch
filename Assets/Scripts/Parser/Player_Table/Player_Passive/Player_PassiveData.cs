...
{    
    ...
    AbsoluteTrust,     // 무한 신뢰 (아군팀의 모든 능력치 증가)
    Discordance,       // 불협화음 (아군 모든 능력치 감소)
    DifferentDreams,   // 동상이몽 (아군 모든 능력치 감소)
    ...
    MonthGoldUp, MatchGoldUp, ReputationUp, GraduationGold //골드 %상승, 졸업시 획득 명성 고정값, 졸업시 골드 획득 고정값    
}
