...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_PassiveDataReader))]
public class Player_PassiveDataReaderEditor : Editor
{
    private Player_PassiveDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_PassiveDataReader)target;
    }
    ...
    void UpdateMethodOne(GstuSpreadSheet ss)
    {
        ...
        Debug.Log($"[Player_PassiveDataReader] Loaded: {data.DataList.Count} rows");
    }
