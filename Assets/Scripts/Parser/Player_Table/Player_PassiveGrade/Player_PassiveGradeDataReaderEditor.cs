...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_PassiveGradeDataReader))]
public class Player_PassiveGradeDataReaderEditor : Editor
{
    private Player_PassiveGradeDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_PassiveGradeDataReader)target;
    }
