...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_PersonalityDataReader))]
public class Player_PersonalityDataReaderEditor : Editor
{
    private Player_PersonalityDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_PersonalityDataReader)target;
    }
