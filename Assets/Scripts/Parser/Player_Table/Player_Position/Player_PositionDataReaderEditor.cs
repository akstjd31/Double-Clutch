...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_PositionDataReader))]
public class Player_PositionDataReaderEditor : Editor
{
    private Player_PositionDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_PositionDataReader)target;
    }
