...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_ReputationDataReader))]
public class Player_ReputationDataReaderEditor : Editor
{
    private Player_ReputationDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_ReputationDataReader)target;
    }
