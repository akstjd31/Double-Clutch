...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_SpeciesDataReader))]
public class Player_SpeciesDataReaderEditor : Editor
{
    private Player_SpeciesDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_SpeciesDataReader)target;
    }
