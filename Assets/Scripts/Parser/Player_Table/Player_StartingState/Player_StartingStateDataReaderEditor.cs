...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_StartingStateDataReader))]
public class Player_StartingStateDataReaderEditor : Editor
{
    private Player_StartingStateDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_StartingStateDataReader)target;
    }
