...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_SynergyDataReader))]
public class Player_SynergyDataReaderEditor : Editor
{
    private Player_SynergyDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_SynergyDataReader)target;
    }
