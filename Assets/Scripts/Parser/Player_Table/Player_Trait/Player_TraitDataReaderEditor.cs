...
#if UNITY_EDITOR
[CustomEditor(typeof(Player_TraitDataReader))]
public class Player_TraitDataReaderEditor : Editor
{
    private Player_TraitDataReader data;
    ...
    void OnEnable()
    {
        data = (Player_TraitDataReader)target;
    }
    ...
    void UpdateMethodOne(GstuSpreadSheet ss)
    {
        ...
        Debug.Log($"[PlayerTraitDataReader] Loaded: {data.DataList.Count} rows");
    }
