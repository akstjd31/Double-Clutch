...
#if UNITY_EDITOR
[CustomEditor(typeof(Event_ResultDataReader))]
public class Event_ResultDataReaderEditor : Editor
{
    private Event_ResultDataReader data;
    ...
    void OnEnable()
    {
        data = (Event_ResultDataReader)target;
    }
