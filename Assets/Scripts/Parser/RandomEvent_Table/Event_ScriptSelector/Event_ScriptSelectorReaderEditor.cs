...
#if UNITY_EDITOR
[CustomEditor(typeof(Event_ScriptSelectorReader))]
public class Event_ScriptSelectorReaderEditor : Editor
{
    private Event_ScriptSelectorReader data;
    ...
    void OnEnable()
    {
        data = (Event_ScriptSelectorReader)target;
    }
