...
#if UNITY_EDITOR
[CustomEditor(typeof(Event_SoundDataReader))]
public class Event_SoundDataReaderEditor : Editor
{
    private Event_SoundDataReader data;
    ...
    void OnEnable()
    {
        data = (Event_SoundDataReader)target;
    }
