...
public class IndividualTraining : ITraining
{
    ...
    public void StartAction()
    {
        ...
        int mainBonus = _target.GetStat(_data.mainPotential).GrowthRate + InfraManager.Instance.GetInfraEffectValueByEffectType(infraEffectType.TrainingBonus) + (int)(_target.GetFosterPassiveValue(_data.mainPotential) * 100);
        ...
        {
            int subBonus = _target.GetStat(_data.subPotential).GrowthRate + InfraManager.Instance.GetInfraEffectValueByEffectType(infraEffectType.TrainingBonus) + (int)(_target.GetFosterPassiveValue(_data.subPotential) * 100);
