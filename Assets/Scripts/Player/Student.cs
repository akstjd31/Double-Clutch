...
public class Student
{
    ...
    public void Init(Player_SpeciesDataReader specieDb, Player_PersonalityDataReader personalityDb, Player_PassiveDataReader passiveDb, Player_TraitDataReader traitDb, Player_PositionDataReader positionDb, Player_VisualDataReader visualDb) //Id 기반으로 데이터 연결하기
    {
        InitStat();
