...
{
    //����Ǵ� ������(-1�� ���Ҵ��� �ǹ�)
    [SerializeField] int _studentId = -1; //�л� �ĺ��� ���� id(�л� ���� Ȯ�� �� �ο�)
    [SerializeField] string _name; //�̸�
    [SerializeField] string _specieId = string.Empty; // ����
    [SerializeField] string _visualId = string.Empty; // ���־� Id
    [SerializeField] string _personalityId = string.Empty; // ���� Id
    [SerializeField] List<string> _passiveIdList = new List<string>(); //�нú� Id
    [SerializeField] string _traitId = string.Empty; //Ư�� Id
    [SerializeField] int _grade = -1; //�г�
    ...
    //���� ���� �� �ҷ����� ������
    Player_SpeciesData _specieData; //����
    Player_VisualData _visualData; //���־�
    Player_PersonalityData _personalityData; //����
    List<Player_PassiveData> _passiveDataList = new List<Player_PassiveData>(); //�нú� ��ų
    Player_TraitData _traitData; //Ư��
    Dictionary<potential, Stat> _statDict = new Dictionary<potential, Stat>(); //����(�����)���
    int _attack;
    int _defense;
    int _attackChange;
    int _defenseChange;
    ...
    public int GetCurrentStat(potential type) //���� ���� ��ġ ��ȯ(�ٷΰ���) �ż���
    {
    ...
    public Stat GetStat(potential type) //���ϴ� Ÿ���� ���� ��ȯ
    {
        if (type == potential.None || !_statDict.ContainsKey(type))
        {
            Debug.LogWarning("potential�� None���� ������ �����Ͱ� �ֽ��ϴ�. �����͸� Ȯ�����ּ���.");
            return null;
        }
    ...
    public void Init(Player_SpeciesDataReader specieDb, Player_PersonalityDataReader personalityDb, Player_PassiveDataReader passiveDb, Player_TraitDataReader traitDb) //Id ������� ������ �����ϱ�
    {
        InitStat();
    ...
    {
        foreach (var stat in _stats) //���� ����Ʈ�� ��ųʸ��� �Ҵ�(��ȸ ���Ǽ�)
        {
    ...
    {
        _attackChange = _attack;  // ���� ���ݷ��� �ӽ� ����
        _defenseChange = _defense; // ���� ������� �ӽ� ����
    }

    private void OnStatChanged() //���� ��� ���ݷ� & ���� ���
    {
        int newAttack = 0;
        int newDefense = 0;
